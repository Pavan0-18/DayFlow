  ...
  return (
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="flex items-center gap-4">
        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#A855F7]/20 to-[#F59E0B]/20 border border-border/30">
          <Shield className="h-6 w-6 text-[#A855F7]" />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-foreground">Monthly Hero Dossier</h1>
      ...
      <GlassPanel variant="default" className="p-3">
        <div className="flex items-center justify-between">
          <Button variant="ghost" size="icon" onClick={() => setDate((d) => subMonths(d, 1))} className="text-muted-foreground hover:text-foreground">
            <ChevronLeft className="h-4 w-4" />
          </Button>
          <span className="text-base font-semibold text-foreground">{format(date, "MMMM yyyy")}</span>
          <Button variant="ghost" size="icon" onClick={() => setDate((d) => addMonths(d, 1))} className="text-muted-foreground hover:text-foreground">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <GlassPanel variant="holographic" className="p-6 space-y-4">
            ...
            <div className="h-48 pt-4">
              <h3 className="text-sm font-semibold text-foreground mb-2">Daily trend</h3>
          ...
          <GlassPanel variant="strong" className="p-6 space-y-4">
            <div>
              <h3 className="text-sm font-semibold text-foreground mb-4">Top completed tasks</h3>
                ...
                <div className="space-y-2">
                  {report.topCompleted.map((t) => (
                    <div key={t.taskId} className="flex justify-between text-sm">
                      ...
                      <span className="text-foreground font-semibold">{t.count}x</span>
                    </div>
                  ))}
                </div>
              ) : (
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground mb-4">Most missed tasks</h3>
